...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 206.0, 299.0, 65.0, 22.0 ],
									"text" : "reset-color"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 417.0, 285.0, 128.0, 32.0 ],
									"saturation" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 417.0, 326.0, 125.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 273.0, 285.0, 128.0, 32.0 ],
									"saturation" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.0, 323.0, 125.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 417.0, 214.0, 128.0, 32.0 ],
									"saturation" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 417.0, 252.0, 124.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 273.0, 210.0, 128.0, 32.0 ],
									"saturation" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.0, 250.0, 119.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 43.0, 294.0, 150.0, 150.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 346.5, 396.0, 49.0, 20.0 ],
									"text" : "Turn on"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 320.5, 395.0, 23.0, 23.0 ],
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 316.5, 393.0, 23.0, 25.0 ],
									"proportion" : 0.5,
									"shape" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 264.5, 378.0, 45.0, 45.0 ]
								}
...
,
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 426.5, 358.0, 201.0, 358.0, 201.0, 283.0, 183.5, 283.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 426.5, 279.5, 183.5, 279.5 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 282.5, 279.5, 183.5, 279.5 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 215.5, 340.0, 199.5, 340.0, 199.5, 283.0, 183.5, 283.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 1 ],
									"midpoints" : [ 282.5, 355.0, 200.0, 355.0, 200.0, 283.0, 183.5, 283.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 41.0, 123.0, 45.0, 22.0 ],
...
,
					"patching_rect" : [ 89.0, 151.0, 25.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
